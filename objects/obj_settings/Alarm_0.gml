...
if(current_month>=3&&current_month<=5){
	a.text=Lang_GetString("str_settings_season_spring")
}
if(current_month>=6&&current_month<=8){
	a.text=Lang_GetString("str_settings_season_summer")
}
if(current_month>=9&&current_month<=11){
	a.text=Lang_GetString("str_settings_season_autumn")
}
if(current_month=12||current_month<=2){
	a.text=Lang_GetString("str_settings_season_winter")
}
alarm[0]=1